					...
					<div id="article" class="wider"><!--TYPO3SEARCH_begin--><div id="c6468115" class="csc-default"><div class="csc-header csc-header-n1"><h1 class="csc-firstHeader">Beregn priser og k�b</h1></div><h2 class="csc-subheader csc-subheader-0">Her kan du beregne priser, k�be forsikringer og bestille tilbud</h2></div><div id="c6445587" class="csc-default"><div class="threecolumns clearfix">
							<div class="col"><div id="c6447635" class="csc-default"><div class="factbox">
									<div class="pad">
										...
										<ul><li>Forsikring af bil og f�rer</li><li>D�kker fx uheld, ansvar og tyveri</li></ul>
                                                                                ...
                                                                                <button type="button" onClick="indkob()">Click Me!</button>
                                                                                
										<p class="readmore"><a href="forsikringer/koeretoej/bilforsikring/" >L�s mere</a></p>
										
										<div class="rmo-simple">
										<li><input class="submit addforsikring" data-product-id="Bil-forsikring" name="tx_topdkrmo_simpleform[submit]" value="Tilf�j indk�bskurv" /></li>
									...
									<div class="pad">
										...
										<div class="rmo-simple">
										<li><input class="submit addforsikring" data-product-id="Ung forsikring" name="tx_topdkrmo_simpleform[submit]" value="Tilf�j indk�bskurv" /></li>
										</div>
									</div>
								</div></div></div>
							...
							<div class="col"><div id="c6453779" class="csc-default"><div class="factbox">
									...
									<div class="pad">
										...
										<div class="rmo-simple">
										<li><input class="submit addforsikring" data-product-id="Rejseforsikring" name="tx_topdkrmo_simpleform[submit]" value="Tilf�j indk�bskurv" /></li>
										</div>
							...
							<div class="col nomargin"><div id="c6459923" class="csc-default"><div class="factbox">
									<div class="pad">
										...
										<div class="rmo-simple">
										<li><input class="submit addforsikring" data-product-id="Husforsikring" name="tx_topdkrmo_simpleform[submit]" value="Tilf�j indk�bskurv" /></li>
										</div>
										<a href="priser/prisberegner/" class="banana">Beregn pris</a>
									</div>
									...
									<div class="pad">
										...
										<br>
										<p class="readmore"><a href="/boerneulykkesforsikring.php" >L�s mere</a></p>
										<div class="rmo-simple">
										<li><input class="submit addforsikring" data-product-id="Børneulykkesforsikring" name="tx_topdkrmo_simpleform[submit]" value="Tilf�j indk�bskurv" /></li>
										</div>
										<a href="C:\Users\Mikkel\phpprojects\first\src\Top\Bundle\MikkelBundle\Resources\views\Default\boerneulykkesforsikring.php" class="banana">Se pris og k�b</a>
									</div>
								</div></div></div>
